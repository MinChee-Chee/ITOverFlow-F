...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-light-800 dark:bg-dark-400 p-1 text-light-500 dark:text-light-500",
      className
    )}
    {...props}
  />
